...
const BACKEND_NAME: &str = "directmedia-mcp-backend.exe";
const BACKEND_PORT: u16 = 10827;
const BACKEND_TAG: &str = "directmedia-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "DIRECTMEDIA_MCP_PORT";
const ENV_HOST: &str = "DIRECTMEDIA_MCP_HOST";
const ENV_TAURI: &str = "DIRECTMEDIA_MCP_TAURI";

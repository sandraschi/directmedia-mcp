...
4. Start the server:
   ...
   uv run python -m directmedia_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn directmedia_mcp.server:app --port 10827
   ```
5. Open `http://localhost:10827` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/directmedia-mcp/issues) |
